...
\pgfplotsset{cycle list/Set1-7,
    ...
    \begin{axis}[
        ...
        \addplot+[
            thick,
        ] table[x=EbN0,y=BER,col sep=comma] {data/rate/10000pkts_code1.csv};
        \addlegendentry{$R=1/2$};
        
        \addplot+[
            thick,
        ] table[x=EbN0,y=BER,col sep=comma] {data/rate/10000pkts_code2.csv};
        \addlegendentry{$R=1/3$};
        
        \addplot+[
            thick,
        ] table[x=EbN0,y=BER,col sep=comma] {data/rate/10000pkts_code3.csv};
        \addlegendentry{$R=1/4$};
        
        \addplot+[
        thick,
        ] table[x=EbN0,y=BER,col sep=comma] {data/rate/10000pkts_code4.csv};
